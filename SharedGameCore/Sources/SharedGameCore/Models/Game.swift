...
public final class Game: Hashable {
  ...
  public var gameType: SharedGameCore.GameType
  ...
  public var serverPosition: SharedGameCore.ServerPosition  // left or right
  public var sideOfCourt: SharedGameCore.SideOfCourt  // side1 or side2
  public var gameState: SharedGameCore.GameState  // serving, playing, completed, paused
  ...
  public init(
    id: UUID = UUID(),
    gameType: SharedGameCore.GameType,
    ...
    currentServer: Int = 1,
    serverNumber: Int = 1,
    serverPosition: SharedGameCore.ServerPosition = .right,
    sideOfCourt: SharedGameCore.SideOfCourt = .side1,
    gameState: SharedGameCore.GameState = .initial,
...
extension Game {
  ...
  public var nextServer:
    (
      server: Int, serverNumber: Int, position: SharedGameCore.ServerPosition,
      side: SharedGameCore.SideOfCourt
    )
  {
    ...
    let newSide: SharedGameCore.SideOfCourt =
    ...
    if effectiveTeamSize == 1 {
      ...
      let newPosition: SharedGameCore.ServerPosition = (score1 + score2) % 2 == 0 ? .right : .left
    ...
    let newPosition: SharedGameCore.ServerPosition = totalScore % 2 == 0 ? .right : .left
