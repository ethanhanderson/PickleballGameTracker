...
public enum GameType: String, CaseIterable, Codable, Hashable, Sendable {
  ...
  public var color: Color {
    DesignSystem.Colors.gameType(self)
  }
  ...
  public var defaultSideSwitchingRule: SideSwitchingRule {
    switch self {
    case .recreational: return .at6Points
    case .tournament: return .at6Points
    case .training: return .at6Points  // Even practice should use real rules
    case .social: return .at6Points  // Could be customized per variation
    case .custom: return .at6Points  // Default, but customizable
    }
  }
  ...
  public var maxTeamSize: Int {
    switch self {
    case .recreational: return 4  // Full range
